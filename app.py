...
#vit_state_dict = torch.load(r'C:\Users\DELL\Documents\University\Semester_9\GenAI\Assignment_3\Q2\vision_transformer_best_model.pth')
vit_state_dict = torch.load(
    r'C:\Users\DELL\Documents\University\Semester_9\GenAI\Assignment_3\Q2\vision_transformer_best_model.pth',
...
#resnet_model = torch.load(r"C:\Users\DELL\Documents\University\Semester_9\GenAI\Assignment_3\Q2\resnet18_PRETRAIN_full_model.pth").to(device).eval()
resnet_model = torch.load(
    r"C:\Users\DELL\Documents\University\Semester_9\GenAI\Assignment_3\Q2\resnet18_PRETRAIN_full_model.pth",
    map_location=torch.device('cpu')
).eval()


# Load Hybrid model
hybrid_state_dict = torch.load(r"C:\Users\DELL\Documents\University\Semester_9\GenAI\Assignment_3\Q2\hybrid_cnn_mlp_best_model.pth", map_location=torch.device('cpu'))
